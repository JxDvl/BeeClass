          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <div className="bg-bee-yellow rounded-full p-2 flex-shrink-0 w-10 h-10 flex items-center justify-center">
                ...
                <div className="ml-4 min-w-[200px]">
                  ...
                  <p className="text-gray-600">+7 (707) 208-71-83</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4 min-w-[200px]">
                  ...
                  <p className="text-gray-600">info@beeclass.ru</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4 min-w-[200px]">
                  ...
                  <p className="text-gray-600">Егизбаева 7/3, офис 91</p>
                </div>
              </div>
            </div>
          </div>
